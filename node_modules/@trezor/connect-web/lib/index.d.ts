...
export declare class TrezorConnectDynamicImpl implements ConnectFactoryDependencies {
    ...
    call(params: CallMethodPayload): Promise<import("@trezor/connect/lib/types").Unsuccessful | import("@trezor/connect/lib/types").SuccessWithDevice<{
        message: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").AuthenticateDeviceResult> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").Address> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").Address[]> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        path: number[];
        publicKey: string;
        serializedPath: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        path: number[];
        publicKey: string;
        serializedPath: string;
    }[]> | import("@trezor/connect/lib/types").SuccessWithDevice<{
    ...
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/blockchain-link-types/lib/common").Transaction[]> | import("@trezor/connect/lib/types").SuccessWithDevice<boolean> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        subscribed: boolean;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        subscribed: boolean;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").CardanoAddress> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").CardanoAddress[]> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        scriptHash: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").CardanoPublicKey> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").CardanoPublicKey[]> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        ...
        address: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<(import("@trezor/connect/lib/types").Address & {
        mac?: string | undefined;
        address: string;
    })[]> | import("@trezor/connect/lib/types").SuccessWithDevice<({
        blockchainLink?: {
        ...
        type: "misc" | "nem";
        curve: string;
    })> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/getDeviceState").DeviceStateResponse> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        ...
        hash: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/getOwnershipId").OwnershipId> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/getOwnershipId").OwnershipId[]> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/getOwnershipProof").OwnershipProof> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/getOwnershipProof").OwnershipProof[]> | import("@trezor/connect/lib/types").SuccessWithDevice<ConnectSettings> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        data: string;
        signature: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/pushTransaction").PushedTransaction> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/requestLogin").Login> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        signature: string;
        serializedTx: string;
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types").SignedTransaction> | import("@trezor/connect/lib/types").SuccessWithDevice<{
        path: number[];
        publicKey: string;
        serializedPath: string;
    } & {
        ...
        mac?: string | undefined;
        address_n: number[];
    }> | import("@trezor/connect/lib/types").SuccessWithDevice<import("@trezor/connect/lib/types/api/checkFirmwareAuthenticity").CheckFirmwareAuthenticityResponse> | {
        id: number;
        success: boolean;
        payload: any;
        device?: import("@trezor/connect/lib/types").DeviceIdentity;
    }>;
