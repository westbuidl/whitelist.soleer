...
export declare const GetPublicKey: import("@sinclair/typebox").TIntersect<[import("@trezor/schema-utils").TObject<{
...
export declare const HDNodeResponse: import("@trezor/schema-utils").TObject<{
    ...
    descriptorChecksum: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString>;
